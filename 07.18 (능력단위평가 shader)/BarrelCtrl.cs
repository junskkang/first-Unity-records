...
public class BarrelCtrl : MonoBehaviour
{
    ...
    void ExpBarrel()
    {
        ...
        foreach(Collider coll in colls)
        {
            ...
            monster = coll.GetComponent<MonsterCtrl>();
            if (a_Barrel == null && monster == null)
                continue;

            if (coll.name.Contains("Barrel"))
            {
            ...
            else if(coll.tag.Contains("MONSTER") && monster.monsterState == MonsterCtrl.MonsterState.petrified)
            {
                monster.MonsterDie();
            }
        }
