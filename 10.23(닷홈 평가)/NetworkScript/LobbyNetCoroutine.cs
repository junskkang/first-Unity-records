...
public class LobbyNetCoroutine : MonoBehaviour
{
    ...
    void Start()
    {
        GetRankListUrl = "http://junskk.dothome.co.kr/GawiBawiBo/Get_ID_Rank.php";
        GetRankPointListUrl = "http://junskk.dothome.co.kr/GawiBawiBo/Get_Point_Rank.php";
    ...
    public void LobbyStart(LobbyMgr a_RefLMgr)
    {
        ...
        m_RefLobbyMgr.RestRk_Btn.interactable = false;
    }
    ...
    public IEnumerator GetRankPointListCo()
    {
        if (GlobalValue.g_Unique_ID == "")
            yield break;    //로그인 실패 상태라면 그냥 리턴
        ...
        UnityWebRequest a_www = UnityWebRequest.Post(GetRankPointListUrl, form);
    ...
    //public IEnumerator NickChangeCo(string a_NickStr, ConfigBox a_RefCfgBox)
    //{
    //    if (GlobalValue.g_Unique_ID == "")
    //        yield break;
    ...
    //        NetworkMgr.Inst.m_NetWaitTimer = 0.0f;
    //        if (a_RefCfgBox != null)
    //            a_RefCfgBox.ResultOkBtn(true, "Request timed out");
    //        yield break;
    //    }
    ...
    //    if (a_RefCfgBox != null)
    //        a_RefCfgBox.ResultOkBtn(a_isWait, a_MsgStr);
    //}
