...
public class InGameNetCoroutine : MonoBehaviour
{
    ...
    void Start()
    {
        BestScoreUrl   = "http://junskk.dothome.co.kr/GawiBawiBo/UpdateBScore.php";
        UpdateNickUrl = "http://junskk.dothome.co.kr/GawiBawiBo/UpdateNickname.php";
        MyPointUrl = "http://junskk.dothome.co.kr/GawiBawiBo/UpdatePoint.php";
    ...
    public IEnumerator NickChangeCo(string a_NickStr)
    {
        ...
        {
            m_RefGameMgr.MessageOnOff(a_MsgStr, true);
        }
    }

    public IEnumerator UpdatePointCo()
    {
        if (GlobalValue.g_Unique_ID == "")
            yield break;
        ...
        UnityWebRequest a_www = UnityWebRequest.Post(MyPointUrl, form);
