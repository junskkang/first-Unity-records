...
public class Game_Mgr : MonoBehaviour
{
    ...
    {
        //false 동안에는 계속 딜레이 시키도록 함
        while (!NetworkMgr.Inst.IsBackLobbyOk())
            yield return null;
    ...
    public void AddScore(int Value = 1)
    {
        ...
        if (bestScoreText != null)
            bestScoreText.text = "Gold : " + GlobalValue.g_BestScore.ToString();
    ...
    void RefreshGameUI()
    {
        ...
        if (bestScoreText != null)
            bestScoreText.text = "Score : " + GlobalValue.g_BestScore.ToString();
